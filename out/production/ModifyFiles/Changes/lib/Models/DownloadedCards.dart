...
//
//     final downloadedCards = downloadedCardsFromJson(jsonString);

import 'dart:convert';

DownloadedCards downloadedCardsFromJson(String str) => DownloadedCards.fromJson(json.decode(str));

String downloadedCardsToJson(DownloadedCards data) => json.encode(data.toJson());

class DownloadedCards {
  DownloadedCards({
    this.cards,
    this.user,
  ...
  factory DownloadedCards.fromJson(Map<String, dynamic> json) => DownloadedCards(
